...
local function create_default_user_commands()
  ...
  vim.api.nvim_create_user_command(prefix .. "Telescope", function()
    actions.open_telescope_picker()
  end, {})
  vim.api.nvim_create_user_command(prefix .. "TelescopeLocal", function()
    actions.open_telescope_picker({ use_global_context = false })
  end, {})
  vim.api.nvim_create_user_command(prefix .. "TelescopeGlobal", function()
    actions.open_telescope_picker({ use_global_context = true })
  end, {})
